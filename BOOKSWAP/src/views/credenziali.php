...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,700;1,400&family=Inter:wght@300;400;600&display=swap%22 rel="stylesheet">
    <style>
        :root {
            ...
            <div class="col-12 login-section">
                <div class="card p-5">
                    ...
                    <header class="text-center mb-4">
                        ...
                        <p class="text-muted small">Benvenuto, <?= htmlspecialchars($_SESSION['nome'] ?? 'Utente') ?>!</p>
                    </header>
                    ...
                    <main>
                        ...
                        <div class="border-top pt-3 mt-3 text-center">
                            <a href="index.php?page=login&action=logout" class="text-decoration-none small text-secondary">
