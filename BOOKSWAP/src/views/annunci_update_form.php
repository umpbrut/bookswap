...
<style>
    ...
    /* Background animato in orizzontale con overlay scuro per evidenziare il form. */
    body {
    ...
    /* Dropdown dei risultati di ricerca: appare sotto il campo input e può scorrere se ci sono molte opzioni. */
    #custom_results {
        position: absolute;
        top: calc(100% + 4px);
        left: 0;
    ...
    /* Dropdown custom per condizioni e stato: il trigger mostra il menu solo al click. */
    ...
    /* Menu a discesa nascosto per la selezione delle opzioni; diventa visibile con il click sul trigger. */
    .select-options-cond,
    ...
    .select-options-stato div:hover {
        background: #ebebeb;
    }
...
<div class="annuncio-card">
    ...
    <form action="index.php?page=annunci&action=edit" method="post">
        ...
        <input type="hidden" name="condizioni" id="condizioni_hidden"
            value="<?= htmlspecialchars($condizioneAttuale) ?>">
        ...
        <div style="margin-bottom:1.5rem;" class="search-container">
            <label>Libro</label>
            <input type="text" id="search" oninput="get_libri()" placeholder="Cerca un libro..." autocomplete="off"
        ...
        <div style="margin-bottom:1.5rem;">
            <label>ISBN</label>
            <input type="text" id="isbn_input" readonly placeholder="Seleziona un libro per vedere l'ISBN"
...
<script>
    ...
    // Interroga il server mentre si digita e mostra risultati cliccabili.
    // Selezionando un libro, aggiorna l'ID nascosto e il campo ISBN. 
    function get_libri() {
