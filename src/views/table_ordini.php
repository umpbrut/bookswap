            ...
            <tbody>
                <?php foreach ($ordinati as $o): ?>
                    ...
                    <tr>
                        ...
                        <td style="color:var(--gold);font-weight:500;">€ <?= number_format($o['prezzo_vendita'], 2, ',', '.') ?></td>
            ...
            <tbody>
                <?php foreach ($venduti as $v): ?>
                    ...
                    <tr>
                        ...
                        <td style="color:var(--gold);font-weight:500;">€ <?= number_format($v['prezzo_vendita'], 2, ',', '.') ?></td>
