...
<form action="index.php?page=login&action=store" method="post" class="row g-3">
    <div class="col-md-6"><input type="text" name="nome" class="form-control" placeholder="Nome" required></div>
    <div class="col-md-6"><input type="text" name="cognome" class="form-control" placeholder="Cognome" required></div>
