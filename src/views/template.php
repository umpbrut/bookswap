...
<head>
    ...
    <title>re-book | ISIT Books</title>
    <link
    ...
    <style>
        ...
        *::after {
        ...
        .dropdown-trigger {
            ...
            transition: color 0.3s;
            user-select: none;
            /* Impedisce di evidenziare il testo al click */
        }
...
<body>
    ...
    <?php
    // Determina la pagina e l'azione correnti dalle query string.
// - `$page` e `$action` vengono usati per:
//    * evidenziare la voce di navigazione attiva
//    * includere la view corretta (es. table.php, table_personal.php)
//    * mostrare o nascondere sezioni come l'hero
    $action = $_GET['action'] ?? 'index';
    $page = $_GET['page'] ?? 'annunci';
    ?>

    <header>
        <a href="index.php?page=annunci" class="logo">re-book</a>
        <nav>
            <a href="index.php?page=annunci" <?= ($page === 'annunci' && $action === 'index') ? 'class="active"' : '' ?>>
                Annunci
            </a>
    ...
    <?php if ($page === 'annunci' && $action === 'index'): ?>
        ...
        <div class="hero">
            ...
            <div class="hero-content">
                <p class="hero-label">re-book — ISIT Books</p>
